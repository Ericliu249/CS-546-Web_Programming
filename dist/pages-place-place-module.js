...
/***/ "./src/app/admin/pages/place/place.component.html":
/*!********************************************************!*\
  !*** ./src/app/admin/pages/place/place.component.html ***!
  \********************************************************/
...
var PlaceComponent = /** @class */ (function () {
    function PlaceComponent(_script, toastr, http, _router, sanitizer) {
    ...
    PlaceComponent.prototype.ngOnInit = function () {
        ...
        this._router.params.subscribe(function (params) {
            _this.model.id = params;
        });
        this.place = this._script.getPlace(this.http, this.model.id['id']);
        this.place.subscribe(function (ress) {
            _this.safeHtml = _this.sanitizer.bypassSecurityTrustHtml(ress['description']);
            _this.safeHtml1 = _this.sanitizer.bypassSecurityTrustHtml(ress['tips']);
            _this.safeHtml2 = _this.sanitizer.bypassSecurityTrustHtml(ress['ticket']);
        });
        this.reviews$ = this._script.getReviews(this.http, this.model.id['id']);
    };
    PlaceComponent.prototype.onSubmit = function () {
        var _this = this;
        this.place.subscribe(function (ress) {
            var id = localStorage.getItem('currentUser');
            _this.user = _this._script.getUserById(_this.http, JSON.parse(id).id);
            _this.user.subscribe(function (data) {
                _this._script.postReviews(_this.http, ress._id, _this.model.content, data.username, data._id).subscribe(function (res) {
                    setTimeout(function () { return _this.toastr.success('Review has been sent!', 'Please reload page!'); });
                });
            });
        });
    };
    ...
    PlaceComponent.prototype.ngAfterContentInit = function () {
        var _this = this;
        setTimeout(function () { return _this.toastr.success('Hello world!', 'Toastr fun!'); });
    };
    PlaceComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-place',
            template: __webpack_require__(/*! ./place.component.html */ "./src/app/admin/pages/place/place.component.html"),
...
/*!***************************************************!*\
  !*** ./src/app/admin/pages/place/place.module.ts ***!
  \***************************************************/
/*! exports provided: PlaceModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PlaceModule", function() { return PlaceModule; });
...
/* harmony import */ var _place_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./place.component */ "./src/app/admin/pages/place/place.component.ts");
...
var routes = [
    {
        ...
        'children': [
            {
                'path': '',
                'component': _place_component__WEBPACK_IMPORTED_MODULE_4__["PlaceComponent"],
            },
        ],
    },
];
var PlaceModule = /** @class */ (function () {
    ...
    PlaceModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [
                _shared_shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes), _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"]
            ], exports: [
                _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"],
            ], declarations: [
                _place_component__WEBPACK_IMPORTED_MODULE_4__["PlaceComponent"],
            ],
        })
    ], PlaceModule);
    return PlaceModule;
